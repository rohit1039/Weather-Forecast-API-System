...
public class V1ApiController implements V1Api {
    ...
    public ResponseEntity<V1LocationsBody1> addLocation(@Parameter(in = ParameterIn.DEFAULT, description = "a JSON object that represents a location", required=true, schema=@Schema()) @Valid @RequestBody V1LocationsBody1 body) {
    ...
    public ResponseEntity<Void> deleteLocation(@Parameter(in = ParameterIn.PATH, description = "code of the location", required=true, schema=@Schema()) @PathVariable("code") String code) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }

    public ResponseEntity<InlineResponse2002> getDailyForecastByLocationCode(@Parameter(in = ParameterIn.PATH, description = "code of the location", required=true, schema=@Schema()) @PathVariable("code") String code) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<InlineResponse2003> getFullWeatherByIPAddress() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<InlineResponse2003> getFullWeatherByLocationCode(@Parameter(in = ParameterIn.PATH, description = "code of the location", required=true, schema=@Schema()) @PathVariable("code") String code) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse2003>(objectMapper.readValue("{\n  \"realtime\" : {\n    \"precipitation\" : 50,\n    \"last_updated\" : \"2000-01-23T04:56:07.000+00:00\",\n    \"temperature\" : 12,\n    \"humidity\" : 72,\n    \"wind_speed\" : 8,\n    \"status\" : \"Sunny\"\n  },\n  \"location\" : \"New York, New York, US\",\n  \"daily_forecast\" : [ {\n    \"precipitation\" : 67,\n    \"month\" : 8,\n    \"min_temp\" : 12,\n    \"max_temp\" : 12,\n    \"day_of_month\" : 8,\n    \"status\" : \"Cloudy\"\n  }, {\n    \"precipitation\" : 67,\n    \"month\" : 8,\n    \"min_temp\" : 12,\n    \"max_temp\" : 12,\n    \"day_of_month\" : 8,\n    \"status\" : \"Cloudy\"\n  } ],\n  \"hourly_forecast\" : [ {\n    \"precipitation\" : 67,\n    \"temperature\" : 19,\n    \"hour_of_day\" : 14,\n    \"status\" : \"Cloudy\"\n  }, {\n    \"precipitation\" : 67,\n    \"temperature\" : 19,\n    \"hour_of_day\" : 14,\n    \"status\" : \"Cloudy\"\n  } ]\n}", InlineResponse2003.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<V1LocationsBody1> getLocation(@Parameter(in = ParameterIn.PATH, description = "code of the location", required=true, schema=@Schema()) @PathVariable("code") String code) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<V1LocationsBody1>(objectMapper.readValue("{\n  \"country_code\" : \"US\",\n  \"city_name\" : \"Los Angeles\",\n  \"location_code\" : \"LACA_US\",\n  \"country_name\" : \"United States of America\",\n  \"region_name\" : \"California\",\n  \"enabled\" : true\n}", V1LocationsBody1.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<InlineResponse200> getRealtimeByIPAddress() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<InlineResponse200> getRealtimeByLocationCode(@Parameter(in = ParameterIn.PATH, description = "code of the location", required=true, schema=@Schema()) @PathVariable("code") String code) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{\n  \"precipitation\" : 50,\n  \"last_updated\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"temperature\" : 12,\n  \"humidity\" : 72,\n  \"location\" : \"New York City, New York, United States of America\",\n  \"wind_speed\" : 8,\n  \"status\" : \"Sunny\"\n}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<InlineResponse2002> listDailyForecastByIPAddress() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse2002>(objectMapper.readValue("{\n  \"location\" : \"New York, New York, US\",\n  \"daily_forecast\" : [ {\n    \"precipitation\" : 67,\n    \"month\" : 8,\n    \"min_temp\" : 12,\n    \"max_temp\" : 12,\n    \"day_of_month\" : 8,\n    \"status\" : \"Cloudy\"\n  }, {\n    \"precipitation\" : 67,\n    \"month\" : 8,\n    \"min_temp\" : 12,\n    \"max_temp\" : 12,\n    \"day_of_month\" : 8,\n    \"status\" : \"Cloudy\"\n  } ]\n}", InlineResponse2002.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<InlineResponse2001> listHourlyForecastByIPAddress() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<InlineResponse2001> listHourlyForecastByLocationCode(@Parameter(in = ParameterIn.PATH, description = "code of the location", required=true, schema=@Schema()) @PathVariable("code") String code) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse2001>(objectMapper.readValue("{\n  \"location\" : \"New York, New York, US\",\n  \"hourly_forecast\" : [ {\n    \"precipitation\" : 67,\n    \"temperature\" : 19,\n    \"hour_of_day\" : 14,\n    \"status\" : \"Cloudy\"\n  }, {\n    \"precipitation\" : 67,\n    \"temperature\" : 19,\n    \"hour_of_day\" : 14,\n    \"status\" : \"Cloudy\"\n  } ]\n}", InlineResponse2001.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<V1LocationsBody> updateLocation(@Parameter(in = ParameterIn.DEFAULT, description = "a JSON object that represents the location information that needs to be updated", required=true, schema=@Schema()) @Valid @RequestBody V1LocationsBody body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
