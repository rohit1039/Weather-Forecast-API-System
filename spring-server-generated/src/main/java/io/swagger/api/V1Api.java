...
public interface V1Api {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "successful retrieval operation. A JSON object representing daily forecast data available for the given location code", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2003.class))),
    ...
    ResponseEntity<InlineResponse2003> getDailyForecastByLocationCode(
            @Parameter(in = ParameterIn.PATH, description = "code of the location", required = true, schema = @Schema()) @PathVariable("code") String code);
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "successful retrieval operation. A JSON object represents full weather forecast information", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2004.class))),
    ...
    ResponseEntity<InlineResponse2004> getFullWeatherByIPAddress();
    ...
    ResponseEntity<InlineResponse2004> getFullWeatherByLocationCode(
            @Parameter(in = ParameterIn.PATH, description = "code of the location", required = true, schema = @Schema()) @PathVariable("code") String code);
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "successful retrieval operation. Realtime data available for the client's location", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2001.class))),

                           @ApiResponse(responseCode = "400", description = "bad request. Could not determine client's IP address"),

                           @ApiResponse(responseCode = "404", description = "No managed location found for the client's IP address")})
    @RequestMapping(value = "/v1/realtime", produces = {"application/json"}, method = RequestMethod.GET)
    ResponseEntity<InlineResponse2001> getRealtimeByIPAddress();
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "successful retrieval operation. Realtime data available for the given location", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2001.class))),
    ...
    ResponseEntity<InlineResponse2001> getRealtimeByLocationCode(
            @Parameter(in = ParameterIn.PATH, description = "code of the location", required = true, schema = @Schema()) @PathVariable("code") String code);
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "successful operation. There are managed locations available.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Location.class))),
    ...
    ResponseEntity<?> listAllLocations();
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "successful retrieval operation. A JSON object representing daily forecast data available for the client's location", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2003.class))),

                           @ApiResponse(responseCode = "400", description = "bad request. Could not determine client's IP address"),

                           @ApiResponse(responseCode = "404", description = "No managed location found for the client's IP address")})
    @RequestMapping(value = "/v1/daily", produces = {"application/json"}, method = RequestMethod.GET)
    ResponseEntity<InlineResponse2003> listDailyForecastByIPAddress();
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "successful retrieval operation. A JSON object representing hourly forecast information available for the client's location", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2002.class))),

                           @ApiResponse(responseCode = "400", description = "bad request. Could not determine client's IP address"),

                           @ApiResponse(responseCode = "404", description = "No managed location found for the client's IP address")})
    @RequestMapping(value = "/v1/hourly", produces = {"application/json"}, method = RequestMethod.GET)
    ResponseEntity<InlineResponse2002> listHourlyForecastByIPAddress();
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "successful retrieval operation. A JSON object representing hourly forecast data available for the given location code", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2002.class))),

                           @ApiResponse(responseCode = "404", description = "No managed location found for the given location code")})
    @RequestMapping(value = "/v1/hourly/{code}", produces = {"application/json"}, method = RequestMethod.GET)
    ResponseEntity<InlineResponse2002> listHourlyForecastByLocationCode(
            @Parameter(in = ParameterIn.PATH, description = "code of the location", required = true, schema = @Schema()) @PathVariable("code") String code);
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "successful update operation. Daily weather forecast data updated successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2003.class))),

                           @ApiResponse(responseCode = "404", description = "no managed location found for the given code")})
    @RequestMapping(value = "/v1/daily/{code}", produces = {"application/json"}, consumes = {"application/json"}, method = RequestMethod.PUT)
    ResponseEntity<InlineResponse2003> updateDailyForecast(
            @Parameter(in = ParameterIn.PATH, description = "code of the location", required = true, schema = @Schema()) @PathVariable("code") String code,
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "successful update operation. Full weather forecast data updated successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2004.class))),

                           @ApiResponse(responseCode = "404", description = "no managed location found for the given code")})
    @RequestMapping(value = "/v1/full/{code}", produces = {"application/json"}, consumes = {"application/json"}, method = RequestMethod.PUT)
    ResponseEntity<InlineResponse2004> updateFullWeather(
            @Parameter(in = ParameterIn.PATH, description = "code of the location", required = true, schema = @Schema()) @PathVariable("code") String code,
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "successful update operation. Hourly weather forecast data updated successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2002.class))),

                           @ApiResponse(responseCode = "404", description = "no managed location found for the given code")})
    @RequestMapping(value = "/v1/hourly/{code}", produces = {"application/json"}, consumes = {"application/json"}, method = RequestMethod.PUT)
    ResponseEntity<InlineResponse2002> updateHourlyForecast(
            @Parameter(in = ParameterIn.PATH, description = "code of the location", required = true, schema = @Schema()) @PathVariable("code") String code,
